                ...
                <div className='px-[20px] md:px-[50px] h-full flex flex-col justify-center'>
                    <div className='flex items-center justify-between md:justify-start'>
                        <div className='flex flex-col items-center md:mr-10'>
                            <span className='block text-[#ffbe0b] font-semibold text-3xl md:text-4xl lg:text-7xl'>00</span>
                            <span className='text-lg md:text-xl lg:text-2xl'>NGÀY</span>
                        </div>
                        <div className='flex flex-col items-center md:mr-10'>
                            <span className='block text-[#fb5607] font-semibold text-3xl md:text-4xl lg:text-7xl'>00</span>
                            <span className='text-2xl'>GIỜ</span>
                        </div>
                        <div className='flex flex-col items-center md:mr-10'>
                            <span className='block text-[#ff006e] font-semibold text-3xl md:text-4xl lg:text-7xl'>00</span>
                            <span className='text-2xl'>PHÚT</span>
                        </div>
                        <div className='flex flex-col items-center md:mr-10'>
                            <span className='block text-[#8338ec] font-semibold text-3xl md:text-4xl lg:text-7xl'>00</span>
                            <span className='text-2xl'>GIÂY</span>
                        </div>
                    </div>
                    <h2 className='my-4 font-bold text-2xl md:text-4xl lg:text-4xl'>SỰ KIỆN CÔNG NGHỆ LỚN NHẤT 2021</h2>
                    <p className='font-medium text-lg md:text-xl'>20 - 25 THÁNG 12, 2022, VIỆT NAM</p>
                </div>
